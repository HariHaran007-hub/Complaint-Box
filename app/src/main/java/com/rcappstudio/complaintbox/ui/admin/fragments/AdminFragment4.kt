...
import com.rcappstudio.complaintbox.databinding.FragmentAdmin4Binding
...
@AndroidEntryPoint
class AdminFragment4 : Fragment(),CompRVAdapter.CardClickListener {

    private lateinit var binding: FragmentAdmin4Binding
    @Inject
    ...
    override fun onCreateView(
        ...
        binding = FragmentAdmin4Binding.inflate(layoutInflater,container,false)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        viewModel.getApprovedData().observe(viewLifecycleOwner) {
    ...
    override fun onCardClick(comp: Complaint) {
        val directions = AdminFragment4Directions.actionAdminFragment4ToViewFragment(Gson().toJson(comp))
